...
\centering
\begin{subfigure}[RMSE]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_Clusterpf_RMSE}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_Clusterpf_time}}
\end{subfigure}
\begin{subfigure}[AER]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_Clusterpf_aggregate_error_ratio}}
\end{subfigure}
\caption{Boxplot of RMSE, runtime and AER of Clusterpf with respect to $NGossip$ and $C$ for 200 Monte Carlo trials ($N=500$). For each value of $NGossip$, from left to right, $C=6, 20, 50, 100$}
