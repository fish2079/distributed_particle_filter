...
\begin{figure}
\centering
\subfigure[$K$=5]{\includegraphics[width=0.3\textwidth]{Figures/RMSE_NbEigen_KNN5}}
\subfigure[$K$=10]{\includegraphics[width=0.3\textwidth]{Figures/RMSE_NbEigen_KNN10}}
\subfigure[$K$=20]{\includegraphics[width=0.3\textwidth]{Figures/RMSE_NbEigen_KNN20}}
...
\begin{figure}
\centering
\subfigure[$K$=5]{\includegraphics[width=0.3\textwidth]{Figures/runtime_NbEigen_KNN5}}
\subfigure[$K$=10]{\includegraphics[width=0.3\textwidth]{Figures/runtime_NbEigen_KNN10}}
\subfigure[$K$=20]{\includegraphics[width=0.3\textwidth]{Figures/runtime_NbEigen_KNN20}}
