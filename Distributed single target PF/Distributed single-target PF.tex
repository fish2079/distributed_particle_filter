...
\end{subfigure}
\caption{Boxplot of RMSE, runtime and AER of CSSpf with respect to $NGossip$ and $N$ for 200 Monte Carlo trials. For each value of $NGossip$, from left to right, $N=100, 250, 500, 1000$}
...
Fig.~\ref{fig:results_LCpf} shows the boxplots of RMSE, total runtime and AER with respect to number of gossip iterations and number of particles over 200 random trials for $d=1$. Each data point is averaged over all time steps. For LCpf, a minimal of 40 gossip iterations is necessary to yield adequate tracking performance. Furthermore, at $d=1$, each sensor needs to broadcast 20 scalars per gossip iteration. In other words, the communication overhead of LCpf is 6 times that of CSSpf (thrice the scalars to aggregate and twice as many gossip iterations) to achieve similar tracking performance. If we compare Fig. 2(c) and Fig. 4(c), we note that CSSpf and LCpf exhibit very similar level of aggregate error ratios for the same $NGossip$. This suggests that LCpf is significantly more susceptible to error induced by distributed summation. Furthrmore, LCpf requires double the runtime of CSSpf with the total runtime increasing for higher $N$. 

\begin{figure}
\centering
\begin{subfigure}[RMSE]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_LCpf_RMSE}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_LCpf_time}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_LCpf_aggregate_error_ratio}}
\end{subfigure}
\caption{Boxplot of RMSE, runtime and AER of LCpf with respect to $NGossip$ and $N$ for 200 Monte Carlo trials. For each value of $NGossip$, from left to right, $N=100, 250, 500, 1000$}
...
\centering
\begin{subfigure}[RMSE]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_LApf_RMSE}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_LApf_time}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.65\textwidth]{Figures/boxplot_LApf_aggregate_error_ratio}}
\end{subfigure}
\caption{Boxplot of RMSE, runtime and AER of LApf with respect to $NGossip$ and $m$ for 200 Monte Carlo trials ($N=500$). For each value of $NGossip$, from left to right, $m=6, 20, 50, 100$}
...
\centering
\begin{subfigure}[RMSE]
{\includegraphics[width=0.72\textwidth]{Figures/boxplot_Clusterpf_RMSE}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.72\textwidth]{Figures/boxplot_Clusterpf_time}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.72\textwidth]{Figures/boxplot_Clusterpf_aggregate_error_ratio}}
\end{subfigure}
\caption{Boxplot of RMSE, runtime and aggregate error ratio of Clusterpf with respect to $NGossip$ and $C$ for 200 Monte Carlo trials ($N=500$). For each value of $NGossip$, from left to right, $C=6, 20, 50, 100$}
...
\centering
\begin{subfigure}[RMSE]
{\includegraphics[width=0.72\textwidth]{Figures/Track3_RMSE}}
\end{subfigure}
\begin{subfigure}[RMSE]
{\includegraphics[width=0.72\textwidth]{Figures/Track3_RMSE_focus}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.72\textwidth]{Figures/Track3_runtime}}
\end{subfigure}
...
\centering
\begin{subfigure}[RMSE]
{\includegraphics[width=0.72\textwidth]{Figures/Track1_RMSE}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.72\textwidth]{Figures/Track1_runtime}}
\end{subfigure}
...
Fig.~\ref{fig:track2} shows the third test track with 16 sensors and Fig.~\ref{fig:Track2_results} shows the results. Again, the runtime display the same trends as in the previous tracks and we focus solely on RMSE. BSpf has the best performance as expected. LCpf is unable to yield adequate tracking performance even when the total overhead exceeds 1200 ($NGossip=60$, 20 scalars to aggregate). CSSpf requires considerably more communication overhead to yield robust tracking performance compared to the previous two tracks. More interestingly, there is significant discrepancy between the two curves of LApf depending on the choice of parameters. Fixing $m$ and increasing $NGossip$ consistently yields robust tracking performance on-par with BSpf. The same trends can be observed in the two curves of Clusterpf. 
...
\centering
\begin{subfigure}[RMSE]
{\includegraphics[width=0.72\textwidth]{Figures/Track2_RMSE}}
\end{subfigure}
\begin{subfigure}[RMSE]
{\includegraphics[width=0.72\textwidth]{Figures/Track2_RMSE_focus}}
\end{subfigure}
\begin{subfigure}[total runtime]
{\includegraphics[width=0.72\textwidth]{Figures/Track2_runtime}}
\end{subfigure}
