...
\begin{figure}
\centering
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track1_bearing_RMSE}}
\end{subfigure}
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track1_bearing_WError}}
\end{subfigure}
\begin{subfigure}[Range only]
{\includegraphics[width=0.45\textwidth]{Figures/Track1_range_RMSE}}
\end{subfigure}
\begin{subfigure}[Range only]
{\includegraphics[width=0.45\textwidth]{Figures/Track1_range_WError}}
\end{subfigure}
...
\centering
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track2_bearing_RMSE}}
\end{subfigure}
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track2_bearing_WError}}
\end{subfigure}
\begin{subfigure}[Range only]
{\includegraphics[width=0.45\textwidth]{Figures/Track2_range_RMSE}}
\end{subfigure}
\begin{subfigure}[Range only]
{\includegraphics[width=0.45\textwidth]{Figures/Track2_range_WError}}
\end{subfigure}
...
Fig.~\ref{fig:Track3_results} shows the tracking results for track 3. Again, LApf and Clusterpf achieve robust tracking performance even with very low communication overhead. LCpf achieves good performance for $NGossip\geq 50$. In bearing-only tracking, CSSpf has poor performance even for $NGossip\geq 100$ even though its weight error is lowest for $NGossip \geq 30$. 

\begin{figure}
\centering
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track3_bearing_RMSE}}
\end{subfigure}
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track3_bearing_WError}}
\end{subfigure}
\begin{subfigure}[Range only]
{\includegraphics[width=0.45\textwidth]{Figures/Track3_range_RMSE}}
\end{subfigure}
\begin{subfigure}[Range only]
{\includegraphics[width=0.45\textwidth]{Figures/Track3_range_WError}}
\end{subfigure}
...
\centering
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track3_bearing_time}}
\end{subfigure}
\begin{subfigure}[Bearing only]
{\includegraphics[width=0.45\textwidth]{Figures/Track3_range_time}}
\end{subfigure}
...
%Eq.~\eqref{eqn:encoding_error_vector} can actually be used as a low bound for Eq.~\eqref{eqn:encoding_error}. 
%\begin{align}
%\frac{||\gamma_{m} - \gamma||}{||\gamma||} &\leq \frac{\sqrt{n}||\gamma_{m} - \gamma||_\infty}{||\gamma||_\infty}
%\end{align}
%where we used the identify $||\gamma||_\infty \leq ||\gamma||_2 \leq \sqrt{n}||\gamma||_\infty$ where $n$ is the number of particles. 
%
%Let $|\gamma_m(x_i)-\gamma(x_i)| = ||\gamma_{m} - \gamma||_\infty$. Furthermore, let $||\gamma||_\infty=|\gamma(x_j)|\geq |\gamma(x_i)|\quad i\neq j$. Then we have
%\begin{align}
%\frac{||\gamma_{m} - \gamma||}{||\gamma||} &\leq \frac{\sqrt{n}||\gamma_{m} - \gamma||_\infty}{||\gamma||_\infty} \\
%&leq 
%\end{align}
...
Fig.~\ref{fig:detailed_results_track1} (g) shows the average discrepancy in normalized particle weights. The curves for CSSpf and LCpf are significantly higher than the other curves until NGossip $>$ 4 and NGossip $>$ 8 as expected. 

\begin{figure}
\centering
\begin{subfigure}[Encoding error $\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_m_time_track1}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the theoretical upper bound]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip_track1}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the alternate theoretical upper bound based on infinity norm]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip2_track1}}
\end{subfigure}
\begin{subfigure}[$\beta$, the error ratio of coefficients $\alpha$]
{\includegraphics[width=0.49\textwidth]{Figures/beta_track1}}
\end{subfigure}
\begin{subfigure}[Average $||\Psi||_\infty||\alpha||_\infty$ over time]
{\includegraphics[width=0.49\textwidth]{Figures/Psi_Alpha_track1}}
\end{subfigure}
...
{\includegraphics[width=0.49\textwidth]{Figures/delta_bound_track1}}
\end{subfigure}
\begin{subfigure}[Average normalized particle weights discrepancy $||w_{\text{true}}-w_{\text{approx}}||_2$]
{\includegraphics[width=0.49\textwidth]{Figures/curve_perturbationGossip_track1}}
\end{subfigure}
\caption{Distributed filter error bound with respect to $NGossip$ and time for track 1 averaged over 40 trials. $N=500$, $d=2,m=C=6$.}
...
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the theoretical upper bound]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip_track2}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the alternate theoretical upper bound based on infinity norm]
...
{\includegraphics[width=0.49\textwidth]{Figures/curve_perturbationGossip_track2}}
\end{subfigure}
\caption{Distributed filter error bound with respect to $NGossip$ and time for track 2 averaged over 40 trials. $N=500$, $d=2,m=C=6$.}
\label{fig:detailed_results_track2}
\end{figure}

Finally, Fig.~\ref{fig:detailed_results_track3} shows the results for track 3. The $\delta_m$ remains below unity for all filters for all time steps. For LCpf-GS, LApf and Clusterpf, the gossiping error remains below 1 even at NGossip = 1. For CSSpf and LCpf, much higher communication overhead is required. These trends are also reflected in the overall $\delta$ and normalized particle weights discrepancy. 

\begin{figure}
\centering
\begin{subfigure}[Encoding error $\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_m_time_track3}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the theoretical upper bound]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip_track3}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the alternate theoretical upper bound based on infinity norm]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip2_track3}}
\end{subfigure}
\begin{subfigure}[$\beta$, the error ratio of coefficients $\alpha$]
{\includegraphics[width=0.49\textwidth]{Figures/beta_track3}}
\end{subfigure}
\begin{subfigure}[Average $||\Psi||_\infty||\alpha||_\infty$ over time]
{\includegraphics[width=0.49\textwidth]{Figures/Psi_Alpha_track3}}
\end{subfigure}
\begin{subfigure}[Log-likelihood error $\delta$, circles represent true errors and solid lines represent the theoretical higher bound $(1+\delta_m)\delta_{\text{gossip}}+\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_bound_track3}}
\end{subfigure}
\begin{subfigure}[Average normalized particle weights discrepancy $||w_{\text{true}}-w_{\text{approx}}||_2$]
{\includegraphics[width=0.49\textwidth]{Figures/curve_perturbationGossip_track3}}
\end{subfigure}
\caption{Distributed filter error bound with respect to $NGossip$ and time for track 3 averaged over 40 trials. $N=500$, $d=2,m=C=6$.}
\label{fig:detailed_results_track3}
\end{figure}

We repeat the same experiments using range measurements. Fig.~\ref{fig:detailed_results_range_track1}-\ref{fig:detailed_results_range_track3} show the results for the three tracks. We notice the same overall trends as in the bearing-only tracking case. 

\begin{figure}
\centering
\begin{subfigure}[Encoding error $\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_m_time_range_track1}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the theoretical upper bound]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip_range_track1}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the alternate theoretical upper bound based on infinity norm]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip2_range_track1}}
\end{subfigure}
\begin{subfigure}[$\beta$, the error ratio of coefficients $\alpha$]
{\includegraphics[width=0.49\textwidth]{Figures/beta_range_track1}}
\end{subfigure}
\begin{subfigure}[Average $||\Psi||_\infty||\alpha||_\infty$ over time]
{\includegraphics[width=0.49\textwidth]{Figures/Psi_Alpha_range_track1}}
\end{subfigure}
\begin{subfigure}[Log-likelihood error $\delta$, circles represent true errors and solid lines represent the theoretical higher bound $(1+\delta_m)\delta_{\text{gossip}}+\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_bound_range_track1}}
\end{subfigure}
\begin{subfigure}[Average normalized particle weights discrepancy $||w_{\text{true}}-w_{\text{approx}}||_2$]
{\includegraphics[width=0.49\textwidth]{Figures/curve_perturbationGossip_range_track1}}
\end{subfigure}
\caption{Distributed filter error bound with respect to $NGossip$ and time for track 1 averaged over 40 trials. $N=500$, $d=2,m=C=6$. Sensors receive range measurements.}
\label{fig:detailed_results_range_track1}
\end{figure}

\begin{figure}
\centering
\begin{subfigure}[Encoding error $\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_m_time_range_track2}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the theoretical upper bound]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip_range_track2}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the alternate theoretical upper bound based on infinity norm]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip2_range_track2}}
\end{subfigure}
\begin{subfigure}[$\beta$, the error ratio of coefficients $\alpha$]
{\includegraphics[width=0.49\textwidth]{Figures/beta_range_track2}}
\end{subfigure}
\begin{subfigure}[Average $||\Psi||_\infty||\alpha||_\infty$ over time]
{\includegraphics[width=0.49\textwidth]{Figures/Psi_Alpha_range_track2}}
\end{subfigure}
\begin{subfigure}[Log-likelihood error $\delta$, circles represent true errors and solid lines represent the theoretical higher bound $(1+\delta_m)\delta_{\text{gossip}}+\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_bound_range_track2}}
\end{subfigure}
\begin{subfigure}[Average normalized particle weights discrepancy $||w_{\text{true}}-w_{\text{approx}}||_2$]
{\includegraphics[width=0.49\textwidth]{Figures/curve_perturbationGossip_range_track2}}
\end{subfigure}
\caption{Distributed filter error bound with respect to $NGossip$ and time for track 2 averaged over 40 trials. $N=500$, $d=2,m=C=6$.}
\label{fig:detailed_results_range_track2}
\end{figure}

\begin{figure}
\centering
\begin{subfigure}[Encoding error $\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_m_time_range_track3}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the theoretical upper bound]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip_range_track3}}
\end{subfigure}
\begin{subfigure}[Gossiping error $\delta_{\text{gossip}}$, circles represent true gossiping errors and sold lines represent the alternate theoretical upper bound based on infinity norm]
{\includegraphics[width=0.49\textwidth]{Figures/delta_gossip2_range_track3}}
\end{subfigure}
\begin{subfigure}[$\beta$, the error ratio of coefficients $\alpha$]
{\includegraphics[width=0.49\textwidth]{Figures/beta_range_track3}}
\end{subfigure}
\begin{subfigure}[Average $||\Psi||_\infty||\alpha||_\infty$ over time]
{\includegraphics[width=0.49\textwidth]{Figures/Psi_Alpha_range_track3}}
\end{subfigure}
\begin{subfigure}[Log-likelihood error $\delta$, circles represent true errors and solid lines represent the theoretical higher bound $(1+\delta_m)\delta_{\text{gossip}}+\delta_m$]
{\includegraphics[width=0.49\textwidth]{Figures/delta_bound_range_track3}}
\end{subfigure}
\begin{subfigure}[Average normalized particle weights discrepancy $||w_{\text{true}}-w_{\text{approx}}||_2$]
{\includegraphics[width=0.49\textwidth]{Figures/curve_perturbationGossip_range_track3}}
\end{subfigure}
\caption{Distributed filter error bound with respect to $NGossip$ and time for track 3 averaged over 40 trials. $N=500$, $d=2,m=C=6$.}
\label{fig:detailed_results_range_track3}
\end{figure}
