...
\end{subfigure}
\caption{RMSE AER of LCpf\_llh with respect to $NGossip$ for different values of $N$. All data points are averaged over 50 time steps and 200 Monte Carlo trials.}
