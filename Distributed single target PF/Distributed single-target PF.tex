...
The LApf has one parameter of interest: $m$, the number of eigenvectors to encode the particle log-likelihoods. Fig.~\ref{} shows the boxplots of RMSE, runtime and aggregate error ratio of LApf with respect to $m$ and $NGossip$ for $N=500$. 


This parameter in-turn interacts directly with $NGossip$. 
