...
%This simulator implements a consensu-based distributed PF in which the
%weights of the particles are calculated using consensus algorithms.
...
%parset.x0 = zeros(4,parset.numTargets);
