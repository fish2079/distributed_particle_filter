function testClusterpf_graph(track, graphMethod, weightedEdge, weightedEdgeStyle)
...
nbClusters_vector = [4,6,9,16,25,50,100,150,200];
...
sim_parameters.graphMethod = graphMethod; %'Delaunay';
...
switch graphMethod
    ...
    for i=1:numel(nbClusters_vector)
        ...
        filename{i} = [filename{i},'_K',num2str(sim_parameters.nbClusters)];
